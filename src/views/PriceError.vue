<template>
    <div id="kt_content_container" class="container-fluid">
        <div class="card">
            <div class="card-body d-flex flex-column align-items-center justify-content-center" style="height: 80vh;">
                    <span class="svg-icon svg-icon-danger svg-icon-5x my-4">
                ...
                <h4>Bilgilerinizi kontrol edin veya tekrar deneyin...</h4>
            </div>
        </div>
    </div>
</template>